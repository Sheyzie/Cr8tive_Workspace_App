...
class Plan(InitDB):
    ...
    plan_name = fields.TextField(unique = True, min_length = 3)
    duration = fields.IntegerField(default = 1, min_value = 1)
    plan_type = fields.TextField(choice=['hourly', 'daily', 'weekly', 'monthly', 'half-year', 'yearly'])
    slot = fields.IntegerField(default = 0)
    guest_pass = fields.IntegerField(default = 1, min_value = 1)
    price = fields.IntegerField(default = 0, min_value = 0)
